...
namespace ImageRecognizerLibrary
{
    public static class MPSExtensions
    {
        ...
        public static MPSVector Vector(IMTLDevice device, MPSVectorDescriptor descriptor, float initialValue)
        {
            ...
            var vectorByteSize = ByteSize(descriptor);
            unsafe
            {
        ...
        public static int ByteSize(this MPSVectorDescriptor descriptor) =>
            (int)descriptor.Length * ByteSize(descriptor.DataType);

        public static int ByteSize(this MPSDataType dataType) =>
            dataType switch
            {
